 ...
 * 
 * This script will populate your Firebase database with all lesson and slide data
 * from your local lesson files.
 */

import { initializeApp } from 'firebase/app';
import { getFirestore, collection, doc, getDocs, setDoc, writeBatch, serverTimestamp, query, where, orderBy } from 'firebase/firestore';
...
console.log('🚀 Populating Database with Lesson Data');
console.log('=====================================\n');
