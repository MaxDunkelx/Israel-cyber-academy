/**
 * Content Slide Component - Unified Content Display
 * Replaces PresentationSlide with cleaner, standardized structure
 * 
          ...
          <div className="text-center relative z-10">
            {content.elements?.map((element, index) => {
              switch (element.type) {
                ...
                default:
                  return (
                    <div key={`unknown-${index}`} className="text-white">
                      אלמנט לא מוכר: {element.type}
                    </div>
                  );
              }
            })}
