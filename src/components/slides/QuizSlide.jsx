  ...
  return (
    <div className="h-[calc(100vh-120px)] flex flex-col items-center justify-center p-8" style={{ minHeight: '500px' }}>
      <div className="max-w-5xl w-full h-full flex flex-col">
        ...
        {/* Content Container */}
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50 shadow-2xl flex-1 flex flex-col">
          {/* Questions */}
                ...
                <div className="space-y-3">
                  {question.options?.map((option) => (
                    <button
                      ...
                      disabled={submitted}
                      className={`w-full p-5 rounded-2xl border-4 transition-all duration-300 text-right text-lg md:text-xl lg:text-2xl font-bold tracking-wide select-none focus:outline-none focus:ring-4 focus:ring-blue-400/50 ${
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-lg md:text-xl lg:text-2xl">{option.text}</span>
                        {selectedAnswers[question.id] === option.id && (
